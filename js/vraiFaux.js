...
function nouvellePartie(){
	...
	var rep ='';
		...
		for (let index = 0; index < data[liste[0]].answers.length; index++) {
			...
			rep = rep + '<div class="card"><label><div class="card-body" id="' + index + '" ><input class="secondary-content" style="opacity:100" type="checkbox" id="rep'+ index +'" onclick="test('+index+')">' + textrep + '</label></div> </div>' ;
